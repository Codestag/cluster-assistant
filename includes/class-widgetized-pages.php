...
class Cluster_Widgetized_Pages {

	private $transient;

	public function __construct() {
		$this->transient = 'cluster_widgetized_pages';
	...
	public function register_widget_areas() {
		...
		foreach ( $pages as $page ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Page: %s', 'cluster-assistant' ), get_the_title( $page ) ),
				'description'   => sprintf( __( 'Widgets that appear on the "%s" page.', 'cluster-assistant' ), get_the_title( $page ) ),
			...
			$query = new WP_Query( array(
				...
				'meta_query' => array(
					array(
						...
						'value' => array( 'template-widgetized.php' ),
						'compare' => 'IN',
					),
				),
			) );
...
$GLOBAL['cluster_widgetized_pages'] = new Cluster_Widgetized_Pages;
