...
add_action( 'widgets_init', function() {
	return register_widget( 'stag_widget_services_section' );
} );

class stag_widget_services_section extends WP_Widget {
	function __construct() {
		$widget_ops = array( 'classname' => 'services-section', 'description' => __( 'Display widgets from Services Sidebar.', 'cluster-assistant' ) );
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'stag_widget_services_section' );
		parent::__construct( 'stag_widget_services_section', __( 'Section: Services', 'cluster-assistant' ), $widget_ops, $control_ops );
	}
