...
function stag_metabox_seo() {
	$meta_box = array(
		'id'          => 'stag_metabox_seo',
		'title'       => __( 'SEO Settings', 'cluster-assistant' ),
		'description' => __( 'Customize the SEO settings of your posts/pages', 'cluster-assistant' ),
		'page'        => 'post',
		'context'     => 'normal',
		'priority'    => 'high',
		'fields'      => array(
			array(
				'name' => __( 'Title', 'cluster-assistant' ),
				'desc' => __( 'Enter the post title, most search engines use a maximum of 60 characters.', 'cluster-assistant' ),
				'id'   => '_stag_seo_title',
				'type' => 'text',
				'std'  => '',
			),
			array(
				'name' => __( 'Description', 'cluster-assistant' ),
				'desc' => __( 'Enter the post SEO description, most search engines use a maximum of 160 characters.', 'cluster-assistant' ),
				'id'   => '_stag_seo_description',
				'type' => 'text',
				'std'  => '',
			),
			array(
				'name' => __( 'Keywords', 'cluster-assistant' ),
				'desc' => __( 'A comma separated list of keywords', 'cluster-assistant' ),
				'id'   => '_stag_seo_keywords',
				'type' => 'text',
				'std'  => '',
			),
			array(
				'name'    => __( 'Meta Robots Index', 'cluster-assistant' ),
				'desc'    => __( 'Do you want robots to index this page?', 'cluster-assistant' ),
			...
			array(
				'name'    => __( 'Meta Robots Follow', 'cluster-assistant' ),
				'desc'    => __( 'Do you want robots to follow links from this page?', 'cluster-assistant' ),
